...
<body>
    <section>
        <h1 class="display-6"> RESTORE PAGE</h1>
    </section>
    <section class="container">
      <table class="table">
        ...
        <?php
          include "koneksi.php";
          $query_mysql = mysqli_query($host, "SELECT * FROM travelog WHERE is_deleted=1")or die(mysql_error());
          $nomor = 1;
          while ($data = mysqli_fetch_array($query_mysql)){
            ...
            <a class="btn btn-primary" role="button" href="hapus.php id=<?php echo $nomor['id_user']; ?>">Restore</a>
            </div>
            </td>
          </tr>
          <?php } ?>
